...
data = {
    ...
    "taskbar_pins": [
        ...
        ("%USERPROFILE%\\scoop\\apps\\ida_pro\\current\\ida64.exe", "IDA Pro", "A disassembler and debugger for analyzing binary files."),
        ("%USERPROFILE%\\scoop\\apps\\binary_ninja\\current\\binaryninja.exe", "Binary Ninja", "A reverse engineering platform."),
